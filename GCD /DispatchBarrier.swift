...
────────────────────────────────────────────
 ...
 ❗ Важно
    ...
    ◉ Он не защищает от логических гонок (например double refresh)
    ◉ Он не защищает от неправильного порядка вызовов
    ◉ Он не защищает от продления жизни объекта (retain)

    Это просто синхронизация доступа.
...
────────────────────────────────────────────
 ...
 🧠 Главное, что нужно запомнить
    ...
    ◉ кастомная concurrent очередь + barrier = безопасная запись
    ◉ sync для чтения
